...
public interface BuildEventTransport {
  ...
  /**
   * Close all open resources, if any. This method will be called on the transport after all
   * events have been sent. If a transport is stateless, it is correct to do nothing.
   */
  void close();
}
